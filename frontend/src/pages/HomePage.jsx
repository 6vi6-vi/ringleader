    ...
    <div className="home-page">
      ...
      <section className="about">
        ...
        <div className="about-content">
          <span className="about-brand">RINGLEADER</span> — это информационная система для организации и проведения выставок собак. Здесь вы можете найти информацию о породах, клубах и экспертах, зарегистрировать своих собак и подать заявки на участие в выставках.
        </div>
      </section>
